        ...
        <div class="container-fluid">
            <div class="card">
                    ...
                    <div class="card-header">
                        <div class="card-title">
                            <button class="btn btn-default btn-sm" type="button"
                                onclick="window.location.href='{{ route('coupons.index') }}'">Reset</button>
                        </div>
                                ...
                                @foreach ($discountCoupons as $discountCoupon)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="deleteCategory({{$discountCoupon->id}})" class="text-danger w-4 h-4 mr-1">
                ...
                <div class="card-footer clearfix">
                    {{ $discountCoupons->links('pagination::bootstrap-5') }}
                </div>
            </div>
        </div>
        <!-- /.card -->
